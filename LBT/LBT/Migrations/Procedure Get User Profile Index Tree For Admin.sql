IF OBJECT_ID ( 'dbo.GetUserProfileIndexTreeForAdmin', 'P' ) IS NOT NULL 
    DROP PROCEDURE dbo.GetUserProfileIndexTreeForAdmin;
GO
CREATE PROCEDURE dbo.GetUserProfileIndexTreeForAdmin @UserId int
AS
BEGIN
